...
export const renderQualifications = () => {
  ...
  const body = `${renderBreadcrumbs(breadcrumbs)}
    <section class="section"><div class="shell narrow">
      ...
      <p class="large-copy">${lawyer.displayName}现执业于${lawyer.organization}。本站仅展示当前执业主体与公开核验路径，不展示可能造成年限误读的历史时间线信息。</p>
      <p class="legal-note">第三方平台页面可能更新，核验时以司法行政公开平台当前展示内容为准。</p>
      <div class="hero-actions"><a class="button primary" href="${officialCredentialUrl}" target="_blank" rel="noopener noreferrer">前往如法网官方公示</a><a class="button secondary" href="${lawyer.profilePath}">返回律师介绍</a></div>
    </div></section>
    ...
    <section class="section"><div class="shell narrow">
      ...
      <ol class="step-grid">
        ...
        <li><span>04</span><h3>核对机构</h3><p>确认当前执业机构为湖南泰宗律师事务所。</p></li>
      </ol>
